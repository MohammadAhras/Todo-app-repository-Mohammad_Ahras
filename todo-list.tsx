                  ...
                  <div className="flex items-center">
                    {editingTaskId === task.id ? (
                      ...
                      <Button
                        ...
                        className="bg-blue-300 hover:bg-blue-500 text-gray-800 dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-gray-200 font-medium py-1 px-2 rounded-md mr-2"
                      >
                        Edit
                      </Button>
                    )}
